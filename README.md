...
Java-разработчик.  
Стэк **Java 17+**, **Spring Framework** (Boot, Cloud, Data, Security), **Apache Kafka**, **PostgreSQL**, **Docker** и **Kubernetes**.  
Мониторинг и observability строю с помощью **Grafana** + Prometheus.

Также имею опыт с **C++** (высокопроизводительные модули) и **Python** + **Django** (быстрые прототипы и внутренние инструменты).
...
<!-- Счётчик просмотров – отображается только число, без подписи -->
<p align="center">
  <img src="https://profile-counter.glitch.me/ваш-никнейм/count.svg" alt="" />
</p>
